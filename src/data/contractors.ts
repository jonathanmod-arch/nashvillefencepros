...
export const CONTRACTORS: Contractor[] = [
  ...
  },
  {
    ...
    name: 'Outdoor Woodworks Inc',
    category: 'decks',
    projectType: 'residential',
    description:
      'Owner-operator deck and screened-porch builder out of an 805 Rivergate Parkway shop in Goodlettsville, building custom wood decks, screened porches, pergolas, and wood fences across Middle Tennessee since 1997. Licensed, bonded, and insured.',
    areas: ['Nashville', 'Hendersonville', 'Brentwood'],
    specialties: ['Custom Wood Decks', 'Screened Porches', 'Pergolas', 'Wood Fences'],
    rating: 0,
    reviews: 0,
    badge: 'Listed on Google',
    license: 'Public Listing',
    ...
    projectsCompleted: '',
    phone: '(615) 450-1721',
    phoneRaw: '+16154501721',
    website: 'https://outdoorwoodworks.com',
    address: '805 Rivergate Parkway, Goodlettsville, TN 37072',
    responseTime: '',
    countiesServed: 'Davidson, Sumner, and surrounding Middle Tennessee',
    googleMapsUrl:
  ...
  },
  {
    ...
    projectType: 'residential',
    description:
      'Franklin-based deck-only builder out of a Mallory Station Road suite, certified installer for Trex, TimberTech, Deckorators, and Fiberon composites. Builds composite and cedar decks, screened porches, pool decks, and deck repairs across Williamson County since 2019.',
    areas: ['Franklin', 'Brentwood', 'Nashville'],
    specialties: ['Composite Decks', 'Trex Installations', 'Screened Porches', 'Deck Repair'],
    rating: 0,
    reviews: 0,
    badge: 'Listed on Google',
    license: 'Public Listing',
    ...
    projectsCompleted: '',
    phone: '(615) 219-9164',
    phoneRaw: '+16152199164',
    website: 'https://harpethdecks.com',
    address: '330 Mallory Station Rd, Suite F16, Franklin, TN 37067',
    responseTime: '',
    countiesServed: 'Williamson, Davidson, and surrounding Middle Tennessee',
    googleMapsUrl:
  ...
  },
  {
    ...
    projectType: 'residential',
    description:
      'Family-owned Murfreesboro builder specializing in screened-in rooms, covered patios, custom decks, pergolas, and retractable-awning enclosures across Rutherford County and the broader Middle Tennessee region. Rutherford County Chamber member with 400+ five-star reviews.',
    areas: ['Murfreesboro', 'Nashville'],
    specialties: ['Screened Porches', 'Covered Patios', 'Custom Decks', 'Pergolas'],
    rating: 0,
    reviews: 0,
    badge: 'Listed on Google',
    license: 'Public Listing',
    ...
    projectsCompleted: '',
    phone: '(615) 649-7757',
    phoneRaw: '+16156497757',
    website: 'https://thecoveredpatio.com',
    address: '1833 Ward Drive, Suite 101B, Murfreesboro, TN 37127',
    responseTime: '',
    countiesServed: 'Rutherford and surrounding Middle Tennessee',
    googleMapsUrl:
