...
export const RESOURCES = [
  ...
  {
    slug: 'landscaping-cost-nashville',
    title: 'How Much Does Landscaping Cost in Nashville?',
    category: 'Cost',
    readTime: '7 min',
    publishedAt: '2026-06-19',
    excerpt:
      'A landscape refresh runs $1,500-$4,000. A full backyard transformation can hit $200,000-plus. Where you land depends on hardscape, irrigation, plant size, and whether you hired a designer or just a crew with a shovel. Nashville-specific tiers, real per-element costs, and the lines contractors leave off the first quote.',
    img: IMAGES.resources['landscaping-cost-nashville'],
    imageAlt: 'Newly landscaped backyard with plantings and hardscape in a Nashville home',
    body: [
      {
        type: 'p',
        text: "A landscape project in Nashville runs anywhere from $1,500 for a refresh-and-mulch weekend to $200,000-plus for a full-property transformation with pool surround, drainage, lighting, and irrigation. Where you land depends on five things: project scope, hardscape-to-softscape ratio, plant size class (3-gallon shrubs vs 25-gallon specimens), whether you hired a designer or just a crew with a shovel, and your lot's slope and access. Below is the actual tier structure, the per-element costs in Nashville as of mid-2026, the line items nobody includes in the first quote, and how to read a quote that doesn't try to hide the markup.",
      },
      { type: 'h2', text: 'What does a full landscape buildout actually cost in Nashville?' },
      {
        type: 'p',
        text: "Most projects fall into one of four tiers. Pick the tier first, then work the line items inside it.",
      },
      {
        type: 'table',
        headers: ['Tier', 'What you get', 'Installed cost in Nashville'],
        rows: [
          ['Refresh + cleanup', 'Beds re-edged, mulch refresh, light pruning, 5-10 replacement shrubs', '$1,500-$4,000'],
          ['Modest install', 'New foundation beds, partial sod renovation, drip line on new beds', '$5,000-$15,000'],
          ['Mid-range design-build', 'Full front or back yard buildout, irrigation system, hardscape patio or walkway, landscape lighting', '$15,000-$45,000'],
          ['Full property transformation', 'Total grading + drainage, mature trees, pool surround, retaining walls, complete irrigation + lighting', '$50,000-$200,000+'],
        ],
      },
      {
        type: 'p',
        text: "The mid-range bracket is where most of my Nashville builds land. The typical phone call is 'I want my front yard to look like the new construction across the street,' and the honest answer is usually 'OK — design fee, ten 7-gallon shrubs, three 15-gallon trees, fresh sod on the front, drip irrigation on the beds — somewhere between $18,000 and $26,000 depending on whether you want lighting.'",
      },
      { type: 'h2', text: 'What does each per-element cost run in 2026?' },
      {
        type: 'table',
        headers: ['Element', 'Installed cost in Nashville'],
        rows: [
          ['Sod (Bermuda)', '$1.50-$2.50/sqft installed with prep'],
          ['Sod (Zoysia premium)', '$2.00-$3.50/sqft installed'],
          ['Sod (Fescue, cool-season)', '$1.75-$2.75/sqft installed'],
          ['Mulch refresh', '$60-$100 per cubic yard installed'],
          ['Foundation shrub (3-gallon)', '$35-$75 installed each'],
          ['Tree (15-gallon)', '$300-$650 installed'],
          ['Tree (mature, 30+ gallon balled-and-burlapped)', '$750-$2,500 installed'],
          ['Specimen Japanese maple', '$800-$2,500 each'],
          ['Irrigation system (typical residential lot)', '$4,000-$10,000'],
          ['Landscape lighting (transformer + 12 LED fixtures)', '$2,500-$5,500'],
          ['Paver patio', '$18-$28/sqft installed'],
          ['Stamped concrete patio', '$14-$22/sqft installed'],
          ['Natural stone walkway', '$25-$45/sqft installed'],
          ['Retaining wall (segmental block, under 4 ft)', '$35-$65/linear foot'],
          ['Retaining wall (engineered, over 4 ft)', '$80-$150/linear foot'],
          ['French drain', '$25-$50/linear foot'],
        ],
      },
      {
        type: 'p',
        text: "The per-element numbers are what you can sanity-check a quote against. A landscape contractor quoting Zoysia sod at $1.20/sqft is using the contractor-grade pallet that won't survive year two. A quote pricing a 'mature tree' at $300 is selling you a 15-gallon and calling it mature. These numbers are the floor of honest pricing, not the ceiling.",
      },
      { type: 'h2', text: 'What\'s the difference between a $5,000 install and a $50,000 install on the same lot?' },
      {
        type: 'p',
        text: "Three things: plant size, hardscape presence, and whether the install is designed.",
      },
      {
        type: 'p',
        text: "The $5,000 install is 30 small shrubs in 3-gallon pots, a yard of mulch, no design work, no irrigation, no hardscape. It looks fine on install day, mediocre by year three, and sparse by year five because nothing was planted at a mature spec.",
      },
      {
        type: 'p',
        text: "The $50,000 install is a designed plan with material specifications, 7- and 15-gallon plant sizes that look established on day one, a 200-square-foot paver patio, a small water feature, drip irrigation on every bed, and landscape lighting on the major plant masses. Same lot, ten times the install — and the value gap shows up in years 3-7 when the cheap install needs to be re-done and the designed install is still settling in.",
      },
      {
        type: 'p',
        text: "The big lever between those two extremes is design fee. A landscape designer costs $1,500-$3,500 for a residential lot and saves you 2-3x that in plant mis-buys, layout errors, and the painful re-do that happens when nothing matures correctly. If you're spending more than $15,000 on landscape, paying for design is not optional — it's the single highest-ROI line on the quote.",
      },
      { type: 'h2', text: 'Where does the money actually go in a landscape quote?' },
      {
        type: 'p',
        text: "A real landscape quote has at least nine line items. If yours is one number on a page, ask for the breakdown before you sign anything.",
      },
      {
        type: 'ul',
        items: [
          'Design fee (if design-build): $500-$3,500 flat, or 7-12 percent of the build cost on larger projects.',
          'Site survey + measurements: $0-$400. Some contractors include this, most should.',
          'Soil amendment (compost, topsoil, lime): $200-$1,200. The line nobody includes in the verbal quote, and the line that determines whether the plants survive year one.',
          'Plant material with markup: typically 2-3x the wholesale price. Varies wildly between nurseries, which is the reason quotes from three contractors on the same plan land $4,000 apart.',
          'Labor (installation crew): typically 35-45 percent of the total. Higher on hardscape-heavy quotes.',
          'Equipment rental (skid steer, mini excavator): $400-$1,200 for a typical project. Built into the labor line on smaller quotes.',
          'Disposal and haul-off: $300-$1,500 depending on how much existing material has to go.',
          'Final cleanup and blow-out: $200-$500. Skip this and you find mulch on your driveway for a month.',
          'Warranty: typically 1 year on contractor-installed plants. No standalone line item, but it should be in the contract.',
        ],
      },
      { type: 'h2', text: 'What drives the price up?' },
      {
        type: 'ul',
        items: [
          'Slope. Anything over 8 percent grade adds 20-40 percent to the labor line. Belle Meade and Forest Hills lots routinely hit this.',
          'Tree roots. Excavation through mature root systems means hand-digging — 4-6x the hourly cost of skid-steer work.',
          'Tight site access. No truck or skid-steer access means materials get carried by hand, which doubles labor. East Nashville and 12 South bungalows with narrow side yards are the classic offenders.',
          'Williamson County HOA review. Brentwood, Franklin, Cool Springs, Spring Hill — the ARC packet plus the 4-8 week review window adds $300-$1,500 in fees and meaningful schedule risk.',
          'Specimen plants. A specimen Japanese maple at $1,200 is six times the price of a 7-gallon at $200, and the install labor is the same.',
          'Custom hardscape. Curves, irregular shapes, cut stone over square pavers — all add 25-50 percent to the hardscape line.',
          'Drainage requirements. Nashville clay drains slowly. Anything with poor existing drainage adds $1,500-$5,000 in French drains, swales, or basin reshaping before the plants can go in.',
          'Premium irrigation. Smart controllers, drip lines, weather-responsive zones — adds $2,000-$4,000 over a basic spray-head system.',
        ],
      },
      { type: 'h2', text: 'What keeps the price down?' },
      {
        type: 'ul',
        items: [
          'Native plants. Cheaper to buy, lower establishment cost, less irrigation needed. Native viburnums, oakleaf hydrangea, and yaupon holly all run 20-30 percent less than the imported equivalents.',
          'Standard plant sizes (3-gallon and 7-gallon). The 15+ gallon sizes look established faster but cost 3-5x. Patience saves money.',
          'Off-season install. November through February gets you 10-15 percent labor discount in Nashville. Most crews are slow then, plants establish well in cool weather, and the contractor will trim the quote.',
          'Owner-supplied plants (sometimes). Some contractors will install plants you buy yourself, BUT this voids the warranty because they don\'t know the source. Only worth it on cheap fillers like 1-gallon perennials.',
          'Free mulch from Metro Public Works. The city compost facility on Bowling Avenue gives away mulch — bring your truck. Saves $300-$600 on a typical refresh.',
          'Phased install. Do the front yard this year, the back yard next year, irrigation the year after. Loses the one-mobilization discount but spreads the cash hit.',
        ],
      },
      { type: 'h2', text: 'What hidden costs hit at the end of the project?' },
      {
        type: 'p',
        text: "Seven line items that show up on the final invoice if they weren't on the first quote:",
      },
      {
        type: 'ul',
        items: [
          'Soil amendment that nobody quoted: $400-$1,500. Skipped quotes assume your existing soil is plantable. In most Nashville clay, it\'s not.',
          'Irrigation expansion when you add new beds mid-project: $200-$800 per zone added.',
          'Tree removal if existing trees conflict with the plan: $800-$3,500 per tree. The arborist quote is separate.',
          'Permit for retaining walls over 4 feet: $150-$500 in Metro Nashville, plus engineer stamp.',
          'HOA design review fees in Williamson County: $300-$1,500 plus a 4-8 week wait.',
          'Erosion control during install (silt fencing, straw waddles): $200-$800. Required by Metro on most graded projects.',
          'Landscape lighting transformer upgrade when you add fixtures later: $400-$800. The transformer that came with the original 12 fixtures can\'t handle the 24 you want next year.',
        ],
      },
      { type: 'h2', text: 'What does ongoing maintenance actually cost in Nashville?' },
      {
        type: 'ul',
        items: [
          'Mowing service: $1,400-$2,800 per year for a typical Nashville lot (28-32 visits, March through November).',
          'Fertilization program: $400-$900 per year (4-6 applications).',
          'Aeration + overseed: $250-$500 per pass, twice a year for Fescue lawns.',
          'Mulch refresh: $300-$700 per year for a typical residential bed footprint.',
          'Bed weeding: $400-$900 per year if hired out.',
          'Foundation pruning: $200-$500 per year for keeping shrubs in shape.',
          'Irrigation maintenance: $150-$300 per year (spring startup + winter blow-out).',
          'Fall leaf cleanup: $300-$700 per round, usually 2-3 rounds in Nashville.',
        ],
      },
      {
        type: 'p',
        text: "Total annual maintenance for a typical Nashville landscape installed at the $15-$25K level: $3,200-$5,800 per year. Plan for it before you install. The number-one regret I hear is 'I spent $30K on landscape and now I'm spending $5K a year just to keep it from looking neglected.' That math should not be a surprise.",
      },
      { type: 'h2', text: 'Does landscaping actually add property value?' },
      {
        type: 'p',
        text: "Front yard landscape recovers 60-80 percent of installed cost at sale — one of the best returns of any exterior project. Backyard recovers less (40-60 percent) unless it's tied to a built-out outdoor living space with a patio, kitchen, or pool. Mature trees are quietly worth $1,500-$10,000 each in appraisal context, which is why removing a 40-year-old oak to install a pool is sometimes a net-negative move on the appraisal.",
      },
      {
        type: 'p',
        text: "The reverse-value math nobody mentions: existing drainage and erosion problems are NEGATIVE value when left unaddressed. A buyer's inspector will flag standing water against the foundation, and the deal either dies or the buyer demands a $5,000-$15,000 credit. Fix the drainage before you fix the plants. The [deck cost article](/resources/deck-cost-nashville) covers parallel logic for tiered exterior spending decisions.",
      },
      { type: 'h2', text: 'How do you read a real landscape quote?' },
      {
        type: 'p',
        text: "Seven things to verify before you sign:",
      },
      {
        type: 'ol',
        items: [
          'Plant list by botanical name AND container size. "10 hollies" is a slogan. "10 Ilex \'Nellie R. Stevens\', 7-gallon, B&B" is a spec.',
          'Soil amendment specified by type and quantity. "Soil prep included" is a slogan. "2 yards of mushroom compost worked into beds at 4-inch depth" is a spec.',
          'Hardscape materials by brand or quarry. "Pavers" is a slogan. "Belgard Cambridge Cobble, Toscana color" is a spec.',
          'Labor breakdown, even if it\'s a lump sum. The labor line should be 35-45 percent of the total. Higher than 55 percent and the materials are being undercharged. Lower than 25 percent and the labor is being underquoted (which means it gets cut from the field).',
          'Warranty terms broken out by category: plant material (1 year on contractor-installed), hardscape (3-5 years typical), workmanship (1-2 years on the install itself).',
          'Cleanup and haul-off specified. Don\'t assume.',
          'Change-order policy. Most landscape projects discover something mid-dig. The policy should say what happens — flat rate, hourly, or written approval before any work proceeds.',
        ],
      },
      {
        type: 'p',
        text: "If any of those seven are missing or vague, ask before signing. The same line-item reading logic from the [fence quote breakdown](/resources/fence-cost-breakdown) applies here, only with more plant taxonomy.",
      },
      { type: 'h2', text: 'What are the red flags in a landscape quote?' },
      {
        type: 'ul',
        items: [
          'Single number for "landscaping" with no breakdown.',
          'No plant list with botanical names, or "plant material to be determined" left blank.',
          'Leyland cypress or running bamboo on the plant list. The [plants article](/resources/best-plants-privacy-fence-nashville) walks through why both are disasters.',
          'No soil amendment line. Nashville clay needs compost or the plants struggle for year one.',
          'Deposit over 50 percent. The Nashville norm is 30-40 percent at signing, the balance on completion.',
          '"We can do it for X if you pay cash." That means no warranty, no insurance backstop, and no recourse when something fails.',
          'No warranty mentioned at all. Reputable Nashville contractors warranty their plant installs for one year and their hardscape for 3-5.',
          'Verbal estimate only, no written breakdown. The number you got verbally is not the number you will be billed.',
        ],
      },
      {
        type: 'p',
        text: "The screening logic from the [seven questions to ask any Nashville installer](/resources/hire-nashville-fence-installer-questions) applies as cleanly to landscape contractors as to fence pros. Both trades have the same gap between contractors who pull permits and warranty their work and contractors who don't. The price difference between the two camps is small. The outcome difference is large.",
      },
      { type: 'h2', text: 'What\'s the one-line recommendation?' },
      {
        type: 'p',
        text: "Spend at the level you want to live with for the next decade. If your budget is $5K, skip the design fee and do a focused refresh of the most-visible 30 percent of the lot. If your budget is $15K-plus, pay for the design fee FIRST and let it shape every other decision — that single $2,000 line will save you four times that in plant mis-buys, layout errors, and re-do work. If your budget is $50K-plus, you're hiring a design-build firm, not a crew, and the contracting model is different — the [directory](/contractors) filtered to Landscaping shows the shops actually set up to do this work in Nashville, and the [plants article](/resources/best-plants-privacy-fence-nashville) covers which species earn their place along the property line.",
      },
    ] as ResourceSection[],
  },
  {
