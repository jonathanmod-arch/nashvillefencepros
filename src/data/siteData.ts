...
export const FENCE_TYPE_FILTERS = [
  'Wood',
  'Vinyl',
  'Aluminum',
  'Chain Link',
...
export const CONTRACTORS = [
  ...
  },
  {
    ...
    types: ['Vinyl', 'Chain Link', 'Farm/Ranch'],
    customerTypes: ['Residential', 'Commercial'],
    featured: false,
    yearsInBusiness: 22,
    licensed: true,
  ...
  {
    name: 'Cumberland Custom Iron',
    rating: 4.9,
    reviews: 108,
    areas: ['Belle Meade', 'Brentwood', 'Forest Hills'],
    specialties: ['Wrought Iron', 'Automated Gates', 'Estate Fencing'],
    types: ['Iron', 'Gates'],
    customerTypes: ['Residential'],
    featured: false,
    yearsInBusiness: 21,
    ...
    insured: true,
    blurb:
      'In-house blacksmithing for one-off iron gates, fences, and railings. The go-to for estate driveways with custom monograms or fully automated entry systems.',
  },
  {
  ...
  {
    name: 'Sylvan Park Fence Studio',
    rating: 4.8,
    reviews: 79,
    areas: ['Sylvan Park', 'West Nashville', 'The Nations'],
    specialties: ['Horizontal Cedar', 'Custom Wood', 'Modern Steel'],
    types: ['Wood', 'Iron'],
    customerTypes: ['Residential'],
    featured: false,
    yearsInBusiness: 6,
    ...
    insured: true,
    blurb:
      'Two-person design-build studio focused on architect-driven horizontal cedar and steel infill for West Nashville bungalows and ADUs.',
  },
  {
  ...
  {
    name: 'Volunteer Fence Co.',
    rating: 4.6,
    reviews: 524,
    areas: ['Davidson County', 'Williamson County', 'Sumner County'],
    specialties: ['Chain Link', 'Wood Privacy', 'Commercial Installs'],
    types: ['Chain Link', 'Wood'],
    customerTypes: ['Residential', 'Commercial'],
    featured: false,
    yearsInBusiness: 31,
    licensed: true,
    insured: true,
    blurb:
      'Three-decade workhorse covering Middle Tennessee. Strong fit for budget chain link, six-foot cedar, and multi-site commercial installs.',
  },
  {
    name: 'Donelson Fence & Deck',
    rating: 4.7,
    reviews: 263,
    areas: ['Donelson', 'Hermitage', 'Mt. Juliet'],
    specialties: ['Vinyl', 'Wood Privacy', 'Composite Decking'],
    types: ['Vinyl', 'Wood'],
    customerTypes: ['Residential'],
    featured: false,
    yearsInBusiness: 12,
    ...
    insured: true,
    blurb:
      'East Davidson favorite. Reliable on bundle projects pairing a six-foot privacy fence with a back deck — same crew, one quote, one schedule.',
  },
  {
    name: 'Music Row Commercial Fence',
    rating: 4.8,
    reviews: 67,
    areas: ['Downtown Nashville', 'Wedgewood-Houston', 'Berry Hill'],
    specialties: ['Commercial Chain Link', 'Security Fencing', 'Temporary Fencing'],
    types: ['Chain Link'],
    ...
    insured: true,
    blurb:
      'Commercial-only specialist. Construction-site fencing, security perimeters, dumpster enclosures, and temporary installs for studios and venues.',
  },
  {
    name: 'Nolensville Pike Fence',
    rating: 4.5,
    reviews: 198,
    areas: ['Nolensville', 'Brentwood', 'Antioch'],
    specialties: ['Wood Privacy', 'Chain Link', 'Repairs'],
    types: ['Wood', 'Chain Link'],
    customerTypes: ['Residential'],
    featured: false,
    yearsInBusiness: 9,
    ...
    insured: true,
    blurb:
      'South Davidson and northern Williamson coverage. Best-value tier — clean cedar privacy and chain link without the design markup.',
  },
]
